package com.sermaluc.bci.ejercicio.configuracion;
...
@EntityScan(basePackages = { "com.sermaluc.bci.ejercicio.entidad" })
...
public class Configuracion {
	...
	public LocalSessionFactoryBean sessionFactory() throws Exception {
		...
		bean.setPackagesToScan("com.sermaluc.bci.ejercicio.entidad");
